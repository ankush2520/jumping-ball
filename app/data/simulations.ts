...
export const categories: Category[] = [
  ...
  },
  {
    ...
    description: "Black vs white armies, collision cascades, circular illusions, and shrinking boundaries.",
...
export const simulations: Simulation[] = [
  ...
  {
    id: "yin-yang-balls",
    title: "Black vs White: Who Owns 60 Seconds?",
    subtitle: "DOUBLE OR DIE",
    description: "Black and white armies bounce through a maze for 60 seconds — hit the 2x orb to multiply, touch ½x and half your balls vanish.",
